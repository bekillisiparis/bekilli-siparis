// GòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉ
// Bekilli Group GÇö Portal v4 App Shell
// 2 sayfa: Sipari+ƒ (3 panel) + Hesab-¦m (2 panel)
// -¦+ƒ mant-¦-ƒ-¦ sayfalarda, burada sadece auth + routing + topnav
// GòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉGòÉ
import { useState, useReducer, useEffect, useRef, useCallback } from 'react';
import SiparisPage from './SiparisPage';
import HesabimPage from './HesabimPage';

// GöÇGöÇ API GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
// GöÇGöÇ API Helper GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
function extractFiyatlar(raw) {
  ...
  // API d+¦ner: { guncelleme, fiyatlar: { "KOD": {fiyat,doviz} }, oncekiFiyatlar }
  // Nested format ise i+º fiyatlar objesini kullan
...
// GöÇGöÇ Dil GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
const LANG = {
  tr: {
    siparis: 'Sipari+ƒ', hesabim: 'Hesab-¦m', cikis: '+ç-¦k-¦+ƒ', yenile: 'Yenile', portal: 'Sipari+ƒ Portal-¦',
    pin_sub: 'Sipari+ƒ portal-¦na giri+ƒ yap-¦n', pin_placeholder: '6 haneli PIN', pin_btn: 'Giri+ƒ',
    pin_error: 'Ge+ºersiz PIN veya ba-ƒlant-¦ hatas-¦', yukleniyor: 'Giri+ƒ yap-¦l-¦yor...',
    oturumu_ac: 'Oturumu a+º-¦k tut', oto_cikis: '15 dk hareketsizlikte otomatik +º-¦k-¦+ƒ',
    // SiparisPage
    katalog: 'Katalog', ara: '+£r++n ara...', tumu: 'T++m++', kategori: 'Kategori', marka: 'OEM Marka', supplier: '+£retici',
    stokta: 'Stokta', stok_yok: 'Yok', bos_katalog: 'Katalogda ++r++n yok',
    ekle_placeholder: '+£r++n kodu veya ad-¦ yaz-¦n...', adet: 'Adet', adet_gir: '#',
    urun: '+£r++n', toplam: 'Toplam', sepet_bos: 'Sepet bo+ƒ',
    satirlar: 'sat-¦r', topAdet: 'adet', fiyatli_toplam: 'Fiyatl-¦ toplam', fiyat_sorun_kalem: 'Fiyat sorulacak',
    gonder: 'Sipari+ƒ G+¦nder', gonderiliyor: 'G+¦nderiliyor...', gonderildi: 'g+¦nderildi',
    hata: 'Hata', iptal_btn: '-¦ptal', guncelle: 'G++ncelle', sil: 'Sil',
    not_placeholder: 'Not ekle (opsiyonel)...',
    // Takip
    takip: 'Takip', bos_siparis: 'Hen++z sipari+ƒ yok',
    beklemede: 'Beklemede', hazirlaniyor: 'Haz-¦rlan-¦yor', kismi: 'K-¦smi', tamamlandi: 'Tamamland-¦', iptal_durum: '-¦ptal',
    // HesabimPage
    bakiye: 'Bakiye', borc_durumu: 'Bor+ºlu', alacak_durumu: 'Alacakl-¦',
    toplam_borc: 'Bor+º', toplam_alacak: 'Alacak',
    acik_fatura: 'A+º-¦k Faturalar', fatura_kisa: 'fatura', fatura_yok: 'A+º-¦k fatura yok',
    odenen: '+ûdenen', gun: 'g++n',
    iade_alacak: '-¦ade Alacaklar-¦', iade_kisa: '-¦ade', iade: '-¦ade / Al-¦+ƒ',
    bildirimler: 'Bildirimler', odemeler: '+ûdemeler', sik_alinanlar: 'S-¦k Al-¦nanlar',
    bildirim_yok: 'Bildirim yok', odeme_yok: '+ûdeme ge+ºmi+ƒi yok',
    tumunu_oku: 'T++m++n++ okundu yap', hesap_bos: 'Hesap bilgisi hen++z olu+ƒturulmad-¦.',
  },
  en: {
...
// GöÇGöÇ App Reducer GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
const appInitial = {
...
// GöÇGöÇ Icons GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
// GöÇGöÇ App GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
export default function App() {
  ...
  // GöÇGöÇ -¦naktiflik GåÆ otomatik +º-¦k-¦+ƒ (keepSession kapal-¦ysa) GöÇGöÇ
  ...
  const REFRESH_COOLDOWN = 5000; // 5 saniye minimum yenileme aral-¦-ƒ-¦
  ...
  async function refreshSiparisler() {
    ...
    } catch (err) { console.warn('Yenileme hatas-¦:', err.message); }
  }
...
// GöÇGöÇ Login GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
function LoginScreen({ t, lang, setLang, theme, toggleTheme, loading, error, onLogin, keepSession, setKeepSession }) {
  ...
  // Hata geldi-ƒinde shake tetikle
  useEffect(() => {
    if (!error) return;
    setShake(true);
    setInput('');
  ...
  return (
    <div className="sip-login-container">
      <div className={`sip-login-card${shake ? ' sip-shake' : ''}`}>
        ...
        <div className="sip-login-title">{t.portal || 'Sipari+ƒ Portal-¦'}</div>
...
// GöÇGöÇ MainApp GÇö 2 Page Layout GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
function MainApp({ t, lang, setLang, theme, toggleTheme, pin, musteri, katalog, fiyatlar, siparisler, hesap, refreshSiparisler, sonYenileme, onLogout }) {
  ...
  // Sayfa ge+ºi+ƒinde otomatik yenileme
  ...
  return (
    <div className="sip-app">
      ...
      {/* GöÇGöÇ Refresh Bar GöÇGöÇ */}
      <div className="sip-refresh">
        <span>{sonYenileme ? sonYenileme.toLocaleTimeString('tr-TR', { hour: '2-digit', minute: '2-digit' }) : "GÇö"}</span>
        <button className="sip-refresh-btn" onClick={refreshSiparisler} title={t.yenile}>Gå+</button>
      </div>
      ...
      {/* GöÇGöÇ Mobile Bottom Nav GöÇGöÇ */}
...
// GöÇGöÇ Theme Toggle GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
// GöÇGöÇ Lang Toggle GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
